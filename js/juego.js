...
var instrucciones = ['Usá las flechas del teclado para mover alguna pieza hacia el espacio en blanco hasta completar la imagen', 'Debajo podés ver la imagen del rompecabezas resuelto'];
...
/* COMPLETAR: Crear función que agregue la última dirección al arreglo de movimientos y utilice actualizarUltimoMovimiento para mostrarlo en pantalla */
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    let elemento1 = grilla[filaPos1][columnaPos1];
    let elemento2 = grilla[filaPos2][columnaPos2];
    grilla[filaPos1][columnaPos1] = elemento2;
    grilla[filaPos2][columnaPos2] = elemento1;
}
...
para que sepas qué se está haciendo a grandes rasgos. NO LAS MODIFIQUES a menos que
...
function mezclarPiezas(veces) {
  ...
  // Acá agregué el contador de movimientos que implementé más arriba para que no cuente los movimientos realizados al mezclar
  ...
  document.body.onkeydown = (function(evento) {
    if (evento.which === codigosDireccion.ABAJO ||
      ...
      moverEnDireccion(evento.which);
        ...
        if (gano) {
          setTimeout(function() {
            document.getElementById("contadorDeMovimientos").innerHTML = contadorDeMovimientos;
              toggleCartelGanador();
              }, 500);
            }
